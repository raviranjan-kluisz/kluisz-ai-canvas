  ...
  docs: [
    {
      ...
      items: [
        {
          type: "doc",
          id: "Get-Started/about-kluisz",
          label: "About Kluisz"
        },
        {
          type: "doc",
          id: "Get-Started/get-started-installation",
          label: "Install Kluisz"
        },
        {
          type: "doc",
          ...
          items: [
            {
              ...
              label: "Trigger flows with the Kluisz API"
            },
            {
              type: "doc",
              id: "Flows/webhook",
      ...
      items: [
        {
          ...
          label: "Kluisz deployment overview"
        },
        {
          type: "doc",
          id: "Deployment/deployment-public-server",
          label: "Deploy a public Kluisz server"
        },
        {
          type: "doc",
          id: "Deployment/deployment-nginx-ssl",
          label: "Deploy Kluisz with Nginx and SSL"
        },
        {
          type: "category",
          ...
          items: [
            "Deployment/develop-application",
            {
              ...
              label: "Kluisz Docker images"
            },
            {
              type: "doc",
              id: "Deployment/deployment-caddyfile",
              label: "Deploy Kluisz on a remote server"
            },
            {
              type: "category",
              label: "Kubernetes",
      ...
      items: [
        {
          ...
          label: "Get started with the Kluisz API",
        },
        {
          type: "doc",
        ...
        {
          type: "link",
          label: "Kluisz API specification",
          href: "/api",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "Support/luna-for-kluisz",
          label: "IBM Elite Support for Kluisz",
        },
      ],
    },
    {
      ...
      value: `
        <a href="https://www.kluisz.org/desktop" target="_blank" class="menu__link">
          ...
          <div class="sidebar-ad-text-container">
            ...
            <span class="sidebar-ad-text sidebar-ad-text-gradient">Kluisz - Multi-tenant AI Canvas</span>
          </div>
        </a>
      `,
    },
