...
This page provides troubleshooting advice for issues you might encounter when using Kluisz or contributing to Kluisz.

## Missing components

As Kluisz development continues, components are often recategorized or deprecated for better alignment or to prepare for new components.
...
If you still cannot locate the component, see [Kluisz GitHub Issues and Discussions](/contributing-github-issues).
