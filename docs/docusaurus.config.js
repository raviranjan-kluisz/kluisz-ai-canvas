...
const config = {
  title: "Kluisz Documentation",
  tagline:
    "Kluisz is a multi-tenant AI canvas for education, letting schools and teams design, run, and manage AI workflows securely. Built on Langflow.",
  favicon: "img/favicon.ico",
  url: "https://docs.kluisz.com",
  baseUrl: process.env.BASE_URL ? process.env.BASE_URL : "/",
  onBrokenLinks: "throw",
  onBrokenMarkdownLinks: "warn",
  onBrokenAnchors: "warn",
  organizationName: "kluisz-ai",
  projectName: "kluisz-ai-canvas",
  trailingSlash: false,
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            position: "right",
            href: "https://github.com/kluisz/kluisz-ai-canvas",
            ...
            'data-platform-title': 'Kluisz Kanvas'
          },
          {
            position: "right",
            href: "https://twitter.com/kluisz_ai",
            ...
            items: [
              {
                html: `<div class="footer-links">
                  <span>© ${new Date().getFullYear()} Kluisz Kanvas</span>
