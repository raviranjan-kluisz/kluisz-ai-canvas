...
from klx.custom.custom_component.base_component import BaseComponent
from klx.helpers import (
...
from klx.services.deps import get_storage_service, get_variable_service, session_scope
from klx.services.storage.service import StorageService
from klx.template.utils import update_frontend_node_with_template_values
from klx.type_extraction import post_process_type
...
if TYPE_CHECKING:
    ...
    from klx.schema.schema import OutputValue
    from klx.services.storage.service import StorageService
...
class CustomComponent(BaseComponent):
    ...
    def tracing_service(self):
        ...
        if self._tracing_service is None:
            from klx.services.deps import get_tracing_service
