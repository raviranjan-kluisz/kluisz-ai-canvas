...
from klx.base.tools.constants import (
    TOOL_OUTPUT_DISPLAY_NAME,
    TOOL_OUTPUT_NAME,
    TOOLS_METADATA_INFO,
    TOOLS_METADATA_INPUT_NAME,
)
from klx.custom.tree_visitor import RequiredInputsVisitor
from klx.exceptions.component import StreamingError
from klx.field_typing import Tool  # noqa: TC001

# Lazy import to avoid circular dependency
# from klx.graph.state.model import create_state_model
# Lazy import to avoid circular dependency
# from klx.graph.utils import has_chat_output
from klx.helpers.custom import format_type
from klx.memory import astore_message, aupdate_messages, delete_message
from klx.schema.artifact import get_artifact_type, post_process_raw
from klx.schema.data import Data
from klx.schema.log import Log
from klx.schema.message import ErrorMessage, Message
from klx.schema.properties import Source
from klx.serialization.serialization import serialize
from klx.template.field.base import UNDEFINED, Input, Output
from klx.template.frontend_node.custom_components import ComponentFrontendNode
from klx.utils.async_helpers import run_until_complete
from klx.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from klx.base.tools.component_tool import ComponentToolkit
    ...
    from klx.inputs.inputs import InputTypes
    from klx.schema.dataframe import DataFrame
    from klx.schema.log import LoggableType
...
class Component(CustomComponent):
    ...
    def _should_track_input(self, input_obj: InputTypes) -> bool:
        ...
        from klx.inputs.input_mixin import SENSITIVE_FIELD_TYPES
    ...
    async def _build_tools_metadata_input(self):
        try:
            from klx.inputs.inputs import ToolsInput
        except ImportError as e:
            msg = "Failed to import ToolsInput from klx.inputs.inputs"
    ...
    def is_connected_to_chat_input(self) -> bool:
        # Lazy import to avoid circular dependency
        from klx.graph.utils import has_chat_input
    ...
    def _ensure_message_required_fields(self, message: Message) -> None:
        ...
        """
        from klx.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI
