...
from klx.graph.schema import INPUT_COMPONENTS, OUTPUT_COMPONENTS, InterfaceComponentTypes, ResultData
from klx.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from klx.graph.vertex.param_handler import ParameterHandler
from klx.interface import initialize
from klx.interface.listing import lazy_load_dict
from klx.log.logger import logger
from klx.schema.artifact import ArtifactType
from klx.schema.data import Data
from klx.schema.message import Message
from klx.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from klx.utils.schemas import ChatOutputResponse
from klx.utils.util import sync_to_async
...
if TYPE_CHECKING:
    ...
    from klx.graph.vertex.schema import NodeData
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from klx.interface.components import ensure_component_loaded
