...
from klx.interface.utils import extract_input_variables_from_prompt
...
from klx.services.deps import get_db_service, get_settings_service
...
def has_chat_output(vertices: dict[Vertex, int]):
    from klx.graph.schema import InterfaceComponentTypes
