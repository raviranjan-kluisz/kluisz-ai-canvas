...
from klx.inputs.inputs import MessageTextInput
from klx.io import DropdownInput, IntInput, SecretStrInput, SliderInput
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        ...
        try:
            output = AzureChatOpenAI(
                ...
                streaming=stream,
                stream_usage=True,  # Enable usage tracking for metering/billing
            )
