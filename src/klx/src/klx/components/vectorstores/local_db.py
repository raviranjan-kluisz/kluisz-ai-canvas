...
from klx.base.vectorstores.utils import chroma_collection_to_data
from klx.inputs.inputs import MultilineInput
from klx.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, TabInput
...
from klx.utils.validate_cloud import raise_error_if_astra_cloud_disable_component
...
class LocalDBComponent(LCVectorStoreComponent):
    ...
    def get_default_persist_dir(self) -> str:
        ...
        from klx.services.cache.utils import CACHE_DIR
