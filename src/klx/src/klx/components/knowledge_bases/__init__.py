...
# This allows imports like: import klx.components.knowledge_bases.ingestion
_redirected_submodules = {
    "klx.components.knowledge_bases.ingestion": "klx.components.files_and_knowledge.ingestion",
    "klx.components.knowledge_bases.retrieval": "klx.components.files_and_knowledge.retrieval",
}
...
def __getattr__(attr_name: str) -> Any:
    ...
    package = "klx.components.files_and_knowledge"
    try:
