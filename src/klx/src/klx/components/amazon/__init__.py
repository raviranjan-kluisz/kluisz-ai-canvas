...
if TYPE_CHECKING:
    from klx.components.amazon.amazon_bedrock_embedding import AmazonBedrockEmbeddingsComponent
    from klx.components.amazon.amazon_bedrock_model import AmazonBedrockComponent
    from klx.components.amazon.s3_bucket_uploader import S3BucketUploaderComponent
