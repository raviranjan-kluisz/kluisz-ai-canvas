...
from klx.inputs import SortableListInput
from klx.io import BoolInput, DropdownInput, HandleInput, SecretStrInput, StrInput
from klx.schema import Data, DataFrame, Message
...
class SaveToFileComponent(Component):
    ...
    async def _upload_file(self, file_path: Path) -> None:
        ...
        from kluisz.api.v2.files import upload_user_file
