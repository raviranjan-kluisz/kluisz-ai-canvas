...
def _get_ibm_watsonx_imports():
    """Lazy import of IBM Watson AI modules to avoid import errors when not installed."""
    try:
        from ibm_watsonx_ai import APIClient, Credentials
        from ibm_watsonx_ai.metanames import EmbedTextParamsMetaNames
        from langchain_ibm import WatsonxEmbeddings

        return EmbedTextParamsMetaNames, WatsonxEmbeddings, APIClient, Credentials
    except ImportError as e:
        msg = (
            "ibm-watsonx-ai and langchain-ibm are required for IBM Watson features. "
            "Install them with: pip install ibm-watsonx-ai>=1.3.1 langchain-ibm>=0.3.8"
        )
        raise ImportError(msg) from e

from klx.base.embeddings.embeddings_class import EmbeddingsWithModels
...
from klx.base.models.openai_constants import OPENAI_EMBEDDING_MODEL_NAMES
from klx.base.models.watsonx_constants import (
    IBM_WATSONX_URLS,
...
class EmbeddingModelComponent(LCEmbeddingsModel):
    ...
    async def build_embeddings(self) -> Embeddings:
        ...
        if provider == "IBM watsonx.ai":
            # Lazy import IBM Watson modules
            EmbedTextParamsMetaNames, WatsonxEmbeddings, APIClient, Credentials = _get_ibm_watsonx_imports()
