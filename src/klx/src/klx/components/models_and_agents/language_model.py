...
def _get_chat_watsonx():
    """Lazy import of ChatWatsonx to avoid import errors when langchain-ibm is not installed."""
    try:
        ...
        msg = (
            "langchain-ibm is required for IBM Watson features. "
            "Install it with: pip install langchain-ibm>=0.3.8"
        )
        raise ImportError(msg) from e

from klx.base.models.anthropic_constants import ANTHROPIC_MODELS
from klx.base.models.google_generative_ai_constants import GOOGLE_GENERATIVE_AI_MODELS
from klx.base.models.google_generative_ai_model import ChatGoogleGenerativeAIFixed
from klx.base.models.model import LCModelComponent
from klx.base.models.model_utils import get_ollama_models, is_valid_ollama_url
from klx.base.models.openai_constants import OPENAI_CHAT_MODEL_NAMES, OPENAI_REASONING_MODEL_NAMES
from klx.field_typing import LanguageModel
from klx.field_typing.range_spec import RangeSpec
from klx.inputs.inputs import BoolInput, MessageTextInput, StrInput
from klx.io import DropdownInput, MessageInput, MultilineInput, SecretStrInput, SliderInput
from klx.log.logger import logger
from klx.schema.dotdict import dotdict
from klx.utils.util import transform_localhost_url
