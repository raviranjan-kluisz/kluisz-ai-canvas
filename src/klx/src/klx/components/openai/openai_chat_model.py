...
from klx.inputs.inputs import BoolInput, DictInput, DropdownInput, IntInput, SecretStrInput, SliderInput, StrInput
...
class OpenAIModelComponent(LCModelComponent):
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        ...
        # Enable stream_usage to get token counts even during streaming
        # This is required for metering/billing to work correctly
        if "stream_options" not in model_kwargs:
            model_kwargs["stream_options"] = {"include_usage": True}
        elif isinstance(model_kwargs.get("stream_options"), dict):
            model_kwargs["stream_options"]["include_usage"] = True
