...
from klx.custom.custom_component.component import _get_component_toolkit
from klx.custom.utils import update_component_build_config
from klx.field_typing import Tool
from klx.io import BoolInput, DropdownInput, IntInput, MultilineInput, Output
from klx.log.logger import logger
from klx.schema.dotdict import dotdict
from klx.schema.message import Message

if TYPE_CHECKING:
    from klx.schema.log import SendMessageFunctionType
...
class CugaComponent(ToolCallingAgentComponent):
    ...
    async def message_response(self) -> Message:
        ...
        try:
            ...
            from klx.schema.content_block import ContentBlock
            from klx.schema.message import MESSAGE_SENDER_AI
            ...
            from klx.base.agents.events import process_agent_events
