...
if TYPE_CHECKING:
    from klx.components.embeddings.similarity import EmbeddingSimilarityComponent
    from klx.components.embeddings.text_embedder import TextEmbedderComponent
