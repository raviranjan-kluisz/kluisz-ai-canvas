...
# This allows imports like: import klx.components.models.embedding_model
_redirected_submodules = {
    "klx.components.models.embedding_model": "klx.components.models_and_agents.embedding_model",
    "klx.components.models.language_model": "klx.components.models_and_agents.language_model",
}
...
def __getattr__(attr_name: str) -> Any:
    ...
    if attr_name == "embedding_model":
        ...
        result = import_module("klx.components.models_and_agents.embedding_model")
        globals()[attr_name] = result
        return result
    if attr_name == "language_model":
        from importlib import import_module

        result = import_module("klx.components.models_and_agents.language_model")
        globals()[attr_name] = result
        return result
    ...
    package = "klx.components.models_and_agents"
    try:
