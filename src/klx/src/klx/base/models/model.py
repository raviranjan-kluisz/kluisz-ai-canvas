...
from klx.base.constants import STREAM_INFO_TEXT
from klx.custom.custom_component.component import Component
from klx.field_typing import LanguageModel
from klx.inputs.inputs import BoolInput, InputTypes, MessageInput, MultilineInput
    ...
    def get_llm(self, provider_name: str, model_info: dict[str, dict[str, str | list[InputTypes]]]) -> LanguageModel:
        ...
        try:
            ...
            with warnings.catch_warnings():
                ...
                models_module = importlib.import_module("klx.components.models")
