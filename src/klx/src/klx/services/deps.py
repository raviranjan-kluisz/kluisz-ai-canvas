...
if TYPE_CHECKING:
    ...
    from klx.services.interfaces import (
...
def get_db_service() -> DatabaseServiceProtocol:
    ...
    """
    from klx.services.database.service import NoopDatabaseService
    from klx.services.schema import ServiceType
...
def get_shared_component_cache_service() -> CacheServiceProtocol | None:
    ...
    from klx.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
