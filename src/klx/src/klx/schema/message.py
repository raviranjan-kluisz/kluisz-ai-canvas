...
from klx.base.prompts.utils import dict_values_to_string
from klx.log.logger import logger
from klx.schema.content_block import ContentBlock
from klx.schema.content_types import ErrorContent
from klx.schema.data import Data
from klx.schema.image import Image, get_file_paths, is_image_file
from klx.schema.properties import Properties, Source
from klx.schema.validators import timestamp_to_str, timestamp_to_str_validator
from klx.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_NAME_USER, MESSAGE_SENDER_USER
from klx.utils.image import create_image_content_dict
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from klx.schema.dataframe import DataFrame  # Local import to avoid circular import
