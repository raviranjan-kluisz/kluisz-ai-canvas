...
from klx.template.frontend_node.base import FrontendNode
from klx.template.template.base import Template

DEFAULT_CUSTOM_COMPONENT_CODE = """from klx.custom import CustomComponent

from typing import Optional, List, Dict, Union
from klx.field_typing import (
    Tool,
)
