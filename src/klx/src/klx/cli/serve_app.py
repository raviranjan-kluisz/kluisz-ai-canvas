...
from klx.cli.common import execute_graph_with_capture, extract_result_data, get_api_key
    ...
    def create_flow_router(flow_id: str, graph: Graph, meta: FlowMeta) -> APIRouter:
        ...
        async def stream_flow(
            ...
            try:
                ...
                from klx.events.event_manager import create_stream_tokens_event_manager
