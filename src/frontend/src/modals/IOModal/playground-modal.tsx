...
import { KluiszButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const sendMessage = useCallback(
    async ({
      ...
      setChatValue("");
      useMessagesStore.getState().setDisplayLoadingMessage(true);
  ...
  const KluiszButtonClick = () => {
    track("KluiszButtonClick");
    customOpenNewTab(KluiszButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={KluiszButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <KluiszLogo className="h-[18px] w-[18px]" />
                      <div className="text-sm">Built with Kluisz</div>
                    </Button>
                  </div>
                )}
              </div>
              ...
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                ...
                >
                  <Button
                    ...
                    onClick={KluiszButtonClick}
                  >
                    <KluiszLogo className="h-[18px] w-[18px] scale-150" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
