...
export default function TemplateCardComponent({
  ...
  return (
    <div
      ...
      className="group flex flex-col cursor-pointer gap-4 overflow-hidden rounded-md p-3 hover:bg-muted focus-visible:bg-muted border border-border"
      tabIndex={0}
    ...
    >
      <div
        className={cn(
          "relative shrink-0 overflow-hidden rounded-md p-1.5 outline-none ring-ring h-fit w-fit",
      ...
      >
        ...
        /> */}
        <img src={WorkflowIcon} alt="Workflow" className="h-5 w-5" />
      </div>
