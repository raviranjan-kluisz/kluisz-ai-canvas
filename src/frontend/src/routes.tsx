...
import { ProtectedSuperAdminRoute } from "./components/authorization/authSuperAdminGuard";
import { ProtectedTenantAdminRoute } from "./components/authorization/authTenantAdminGuard";
            ...
            <Route path="" element={<AppAuthenticatedPage />}>
              <Route path="" element={<CustomDashboardWrapperPage />}>
                ...
                <Route
                  ...
                  element={
                    <ProtectedTenantAdminRoute>
                      <TenantAdminPage />
                    </ProtectedTenantAdminRoute>
                  }
                />
                <Route path="my-usage" element={<UserUsagePage />} />
              </Route>
              <Route path="flow/:id/">
                <Route path="" element={<CustomDashboardWrapperPage />}>
