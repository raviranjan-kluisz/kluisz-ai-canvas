...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Kluisz documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Kluisz: Create, Chain, Communicate.",
 ...
 *
 */
export const ADMIN_HEADER_TITLE = "Kluisz Kanvas Admin";
...
export const ADMIN_HEADER_DESCRIPTION =
  "Navigate through this section to efficiently oversee all Kluisz Kanvas users. From here, you can seamlessly manage user accounts.";
...
export const API_PAGE_PARAGRAPH =
  "Your secret Kluisz API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const KLUISZ_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const KLUISZ_CHAT_TITLE = "Kluisz Chat";
...
export const STORE_TITLE = "Kluisz Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Kluisz API key.";
...
export const KLUISZ_ACCESS_TOKEN = "access_token_kz";
export const KLUISZ_API_TOKEN = "apikey_tkn_kz";
export const KLUISZ_AUTO_LOGIN_OPTION = "auto_login_kz";
export const KLUISZ_REFRESH_TOKEN = "refresh_token_kz";

export const KLUISZ_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const KLUISZ_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN =
  !getEnvVar("KLUISZ_AUTO_LOGIN") ||
  String(getEnvVar("KLUISZ_AUTO_LOGIN"))?.toLowerCase() !== "false";
...
export const DISCORD_URL = "https://discord.gg/kluisz";
export const GITHUB_URL = "https://github.com/kluisz/kluisz-ai-canvas";
export const TWITTER_URL = "https://x.com/kluisz_ai";
export const DOCS_URL = "https://docs.kluisz.com";
export const DATASTAX_DOCS_URL =
  "https://docs.kluisz.com";
export const DESKTOP_URL = "https://www.kluisz.com"; // Note: Kluisz doesn't have a desktop app, this is a placeholder
export const BUG_REPORT_URL = "https://github.com/kluisz/kluisz-ai-canvas/issues";
