  ...
  useEffect(() => {
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/kluisz/kluisz-ai-canvas/main/examples",
        "https://api.github.com/repos/kluisz/kluisz-ai-canvas/contents/examples",
        "https://api.github.com/repos/kluisz/kluisz-ai-canvas",
        "auto_login",
      ];
