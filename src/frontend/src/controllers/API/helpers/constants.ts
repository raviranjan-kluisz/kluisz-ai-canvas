...
export const URLs = {
  ...
  LICENSE_TIERS: `admin/license-tiers/`,
  LICENSE_POOLS: `admin/license-pools/`,
  USER_LICENSES: `admin/user-licenses/`,
} as const;
...
export function getURL(
  ...
  let url = URLs[key];
  // Remove trailing slash if params will be added
  if (Object.keys(params).length > 0 && url.endsWith('/')) {
    url = url.slice(0, -1);
  }
