          ...
          <div className="group/checkbox relative flex items-center">
            ...
            >
              <Checkbox
                ...
                className={cn(
                  "ml-3.5 transition-opacity focus-visible:ring-0",
            ...
            <div
              className={cn(
                `item-center flex justify-center rounded-lg p-3 transition-opacity duration-200 bg-muted border border-border`,
                selected
                  ? "duration-300"
            ...
            >
              {/* <ForwardedIconComponent
                name={flowData?.icon || WorkflowIcon}
                aria-hidden="true"
