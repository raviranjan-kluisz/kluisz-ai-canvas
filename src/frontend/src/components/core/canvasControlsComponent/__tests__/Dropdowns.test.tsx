...
jest.mock("@/constants/constants", () => ({
  __esModule: true,
  DATASTAX_DOCS_URL: "https://docs.kluisz.com",
  DOCS_URL: "https://docs.kluisz.com",
  DESKTOP_URL: "https://desktop.kluisz.com",
}));

jest.mock("@/customization/feature-flags", () => ({
  ENABLE_DATASTAX_KLUISZ: false,
}));
...
describe("HelpDropdown", () => {
  ...
  it("opens docs in new tab and navigates to shortcuts", () => {
    ...
    fireEvent.click(
      screen.getByTestId("canvas_controls_dropdown_get_kluisz_desktop"),
    );
    expect(window.open).toHaveBeenCalledWith(
      "https://desktop.kluisz.com",
      "_blank",
    );
  });
});
