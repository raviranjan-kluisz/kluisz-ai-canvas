          ...
          <Card className="p-8">
            ...
            <CardContent className="grid">
              <div>
                <p>
                  ...
                  <a
                    href="https://github.com/kluisz/kluisz-ai-canvas/issues"
                    target="_blank"
            ...
            <CardFooter>
              <div className="m-auto mt-4 flex justify-center">
                <Button onClick={resetErrorBoundary}>Restart Kluisz Kanvas</Button>

                <a
                  href="https://github.com/kluisz/kluisz-ai-canvas/issues/new"
                  target="_blank"
                  rel="noopener noreferrer"
                >
