...
import {
  IS_AUTO_LOGIN,
  KLUISZ_ACCESS_TOKEN_EXPIRE_SECONDS,
  KLUISZ_ACCESS_TOKEN_EXPIRE_SECONDS_ENV,
...
export const ProtectedRoute = ({ children }) => {
  ...
  useEffect(() => {
    const envRefreshTime = KLUISZ_ACCESS_TOKEN_EXPIRE_SECONDS_ENV;
    const automaticRefreshTime = KLUISZ_ACCESS_TOKEN_EXPIRE_SECONDS;
