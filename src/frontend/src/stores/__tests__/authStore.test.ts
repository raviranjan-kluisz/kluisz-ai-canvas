...
jest.mock("@/constants/constants", () => ({
  KLUISZ_ACCESS_TOKEN: "kluisz_access_token",
  KLUISZ_API_TOKEN: "kluisz_api_token",
}));
...
describe("useAuthStore", () => {
  beforeEach(() => {
    ...
    mockCookies.get.mockImplementation((key) => {
      switch (key) {
        case "kluisz_access_token":
          return null;
        case "kluisz_api_token":
          return null;
        default:
          return null;
      }
  ...
  describe("edge cases and error scenarios", () => {
    ...
    it("should handle complex user data object", () => {
      ...
      expect(result.current.userData?.is_platform_superadmin).toBe(true);
