...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "uv run uvicorn --factory kluisz.main:create_app --host localhost --port 7860 --loop asyncio --log-level error --no-access-log",
      port: 7860,
      env: {
        KLUISZ_DATABASE_URL: "sqlite:///./temp",
        KLUISZ_AUTO_LOGIN: "true",
        KLUISZ_DEACTIVATE_TRACING: "true",
        KLUISZ_LOG_LEVEL: "ERROR",
        DO_NOT_TRACK: "true",
      },
      stdout: "ignore",
