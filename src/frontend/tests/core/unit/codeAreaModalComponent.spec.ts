...
test(
  ...
  async ({ page }) => {
    ...
    const codeInputCode = `
# from kluisz.field_typing import Data
from kluisz.custom import Component
from kluisz.io import CodeInput, Output
from kluisz.schema import Data
...
class CustomComponent(Component):
    ...
    documentation: str = "https://docs.kluisz.org/components-custom-components"
...
from kluisz.field_typing import Code
from kluisz.interface.custom.custom_component import CustomComponent
from kluisz.interface.custom.utils import get_function
