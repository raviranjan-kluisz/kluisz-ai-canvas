from klx.components.huggingface.huggingface import DEFAULT_MODEL, HuggingFaceEndpointsComponent
from klx.inputs.inputs import DictInput, DropdownInput, FloatInput, IntInput, SecretStrInput, SliderInput, StrInput
