...
from klx.base.models.openai_constants import (
    OPENAI_CHAT_MODEL_NAMES,
    OPENAI_REASONING_MODEL_NAMES,
)
from klx.components.models_and_agents import AgentComponent
from klx.components.tools.calculator import CalculatorToolComponent
...
class TestAgentComponent(ComponentTestBaseWithoutClient):
    ...
    async def test_agent_filters_empty_chat_history_messages(self):
        ...
        from klx.base.agents.utils import data_to_messages
...
class TestAgentComponentWithClient(ComponentTestBaseWithClient):
    ...
    async def test_agent_receives_string_from_message_object_with_anthropic(self):
        ...
        api_key = os.getenv("ANTHROPIC_API_KEY")
        from klx.base.models.anthropic_constants import ANTHROPIC_MODELS_DETAILED
        from klx.schema.message import Message
