...
from klx.custom import Component, CustomComponent
from klx.custom.code_parser.code_parser import CodeParser, CodeSyntaxError
from klx.custom.custom_component.base_component import BaseComponent, ComponentCodeNullError
...
from klx.field_typing import BaseLanguageModel
...
def test_custom_component_subclass_from_lctoolcomponent():
    ...
    code = dedent("""
    from klx.base.langchain_utilities.model import LCToolComponent
...
def test_build_custom_component_template_includes_metadata_with_module():
    ...
    from klx.inputs import MessageTextInput
