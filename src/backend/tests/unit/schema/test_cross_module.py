...
from klx.schema.data import Data as LfxData
...
class TestDuckTypingWithInputs:
    ...
    def test_message_input_accepts_lfx_message(self):
        ...
        from klx.inputs.inputs import MessageInput
    ...
    def test_data_input_accepts_lfx_data(self):
        ...
        from klx.inputs.inputs import DataInput
...
class TestDuckTypingInputMixin:
    ...
    def test_base_input_mixin_is_cross_module(self):
        ...
        from klx.inputs.input_mixin import BaseInputMixin
        from klx.schema.cross_module import CrossModuleModel
