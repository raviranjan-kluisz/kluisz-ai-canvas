...
def create_kluisz_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Kluisz initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Kluisz", "Setting up basic configuration"),
        ...
        ("Launching Kluisz", "Starting server and final setup"),
    ]
...
def create_kluisz_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Kluisz shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
