...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("kluisz.project.name", self.project_name)
            self.root_span.set_attribute("kluisz.flow.name", self.flow_name)
            self.root_span.set_attribute("kluisz.flow.id", self.flow_id)
