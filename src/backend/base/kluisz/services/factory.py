...
def import_all_services_into_a_dict():
    ...
    for service_type in ServiceType:
        try:
            ...
            # Special handling for mcp_composer which is now in klx module
            if service_name == "mcp_composer":
                module_name = f"klx.services.{service_name}.service"
            else:
                module_name = f"kluisz.services.{service_name}.service"
    ...
    # Import settings service from klx
