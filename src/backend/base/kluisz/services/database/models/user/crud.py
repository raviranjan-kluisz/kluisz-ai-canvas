...
from kluisz.services.database.models.user.model import User, UserUpdate
...
async def get_all_superadmins(db: AsyncSession) -> list[User]:
    """Get all super admin accounts from the database."""
