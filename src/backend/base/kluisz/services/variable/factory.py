...
from kluisz.services.variable.service import DatabaseVariableService, VariableService
...
class VariableServiceFactory(ServiceFactory):
    ...
    def create(self, settings_service: SettingsService):
        ...
        if settings_service.settings.variable_store == "kubernetes":
            ...
            from kluisz.services.variable.kubernetes import KubernetesSecretService
