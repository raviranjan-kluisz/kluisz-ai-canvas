...
from kluisz.api.utils import CurrentActiveUser, DbSession, cascade_delete_flow, custom_params, remove_api_keys
from kluisz.api.utils.mcp.config_utils import validate_mcp_server_for_project
from kluisz.api.v1.auth_helpers import handle_auth_settings_update
from kluisz.api.v1.flows import create_flows
from kluisz.api.v1.mcp_projects import get_project_sse_url, register_project_with_composer
from kluisz.api.v1.schemas import FlowListCreate
from kluisz.api.v2.mcp import update_server
from kluisz.helpers.flow import generate_unique_flow_name
from kluisz.helpers.folders import generate_unique_folder_name
from kluisz.initial_setup.constants import ASSISTANT_FOLDER_NAME, STARTER_FOLDER_NAME
from kluisz.services.auth.mcp_encryption import encrypt_auth_settings
from kluisz.services.database.models.api_key.crud import create_api_key
from kluisz.services.database.models.api_key.model import ApiKeyCreate
from kluisz.services.database.models.flow.model import Flow, FlowCreate, FlowRead
from kluisz.services.database.models.folder.constants import DEFAULT_FOLDER_NAME
from kluisz.services.database.models.folder.model import (
    Folder,
    FolderCreate,
    FolderRead,
    FolderReadWithFlows,
...
from kluisz.services.database.models.folder.pagination_model import FolderWithPaginatedFlows
from kluisz.services.deps import get_service, get_settings_service, get_storage_service
from kluisz.services.schema import ServiceType

# Rebuild models to ensure all forward references are resolved
# This is needed for Pydantic to properly handle Union types in response_model
...
@router.get("/{project_id}", response_model=Union[FolderWithPaginatedFlows, FolderReadWithFlows], status_code=200)
