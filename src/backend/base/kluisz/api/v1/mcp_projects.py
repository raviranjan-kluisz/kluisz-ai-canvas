...
from klx.base.mcp.constants import MAX_MCP_SERVER_NAME_LENGTH
from klx.base.mcp.util import sanitize_mcp_name
from klx.log import logger
from klx.services.deps import get_settings_service, session_scope
from klx.services.mcp_composer.service import MCPComposerError, MCPComposerService
from klx.services.schema import ServiceType
...
from kluisz.api.utils import CurrentActiveMCPUser, extract_global_variables_from_headers
from kluisz.api.utils.mcp import auto_configure_starter_projects_mcp, get_project_sse_url, get_url_by_os
from kluisz.api.v1.auth_helpers import handle_auth_settings_update
from kluisz.api.v1.mcp_utils import (
...
from kluisz.services.auth.mcp_encryption import decrypt_auth_settings, encrypt_auth_settings
from kluisz.services.auth.utils import AUTO_LOGIN_WARNING
from kluisz.services.database.models import Flow, Folder
from kluisz.services.database.models.api_key.crud import check_key, create_api_key
...
from kluisz.services.deps import get_service
...
async def verify_project_auth(
    ...
    if not settings_service.auth_settings.SUPERADMIN:
        raise HTTPException(
            ...
            detail="Missing super admin username in auth settings",
        )
...
async def verify_project_auth_conditional(
    ...
    async with session_scope() as session:
        ...
        from kluisz.services.auth.utils import get_current_user_mcp
...
async def get_or_start_mcp_composer(auth_config: dict, project_name: str, project_id: UUID) -> None:
    ...
    """
    from klx.services.mcp_composer.service import MCPComposerConfigError
