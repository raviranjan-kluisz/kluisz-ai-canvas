...
from kluisz.api.utils import CurrentActiveUser, check_kluisz_version
from kluisz.services.auth import utils as auth_utils
from kluisz.services.deps import get_settings_service, get_store_service
from kluisz.services.store.exceptions import CustomError
from kluisz.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_kluisz_version(component)
