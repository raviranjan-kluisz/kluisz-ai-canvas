...
from klx.base.agents.utils import safe_cache_get, safe_cache_set
from klx.base.mcp.util import update_tools

from kluisz.api.utils import CurrentActiveUser, DbSession, require_any_feature
from kluisz.api.v2.files import (
    MCP_SERVERS_FILE,
    delete_file,
    download_file,
    edit_file_name,
...
from kluisz.logging import logger
from kluisz.services.deps import get_settings_service, get_shared_component_cache_service, get_storage_service
from kluisz.services.settings.service import SettingsService
...
# MCP Feature dependency - requires either MCP integration or MCP config UI feature
McpFeatureRequired = Annotated[bool, Depends(require_any_feature("integrations.mcp", "ui.advanced.mcp_server_config"))]
...
async def get_servers(
    ...
    storage_service: Annotated[StorageService, Depends(get_storage_service)],
    settings_service: Annotated[SettingsService, Depends(get_settings_service)],
    _feature_check: McpFeatureRequired,
    *,
