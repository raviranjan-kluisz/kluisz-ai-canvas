...
from klx.log.logger import InterceptHandler
from uvicorn.workers import UvicornWorker


class KluiszUvicornWorker(UvicornWorker):
...
class KluiszApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "kluisz.server.KluiszUvicornWorker"
