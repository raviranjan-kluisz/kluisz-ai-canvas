...
through the klx.components package and processing each module. The index is
...
def build_component_index():
    """Build the component index by scanning all modules in klx.components.
    ...
    try:
        ...
        from klx.interface.components import import_langflow_components
...
def main():
    ...
    output_path = Path(__file__).parent.parent / "src" / "klx" / "src" / "klx" / "_assets" / "component_index.json"
