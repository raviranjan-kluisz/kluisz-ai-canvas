"""Script to update Kluisz Kanvas starter projects with the latest component versions."""

import asyncio
import os

import kluisz.main  # noqa: F401
...
async def main():
    ...
    Copies the code from kluisz/initial_setup/setup.py. Doesn't use the
