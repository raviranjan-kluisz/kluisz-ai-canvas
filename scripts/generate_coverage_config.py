...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "kluisz" / "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/kluisz --cov-config=.coveragerc")
